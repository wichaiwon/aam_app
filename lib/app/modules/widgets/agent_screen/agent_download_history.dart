...
import 'package:aam_app/app/modules/widgets/agent_screen/agent_share_qr_code.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';

class AgentDownloadHistory extends StatefulWidget {
  const AgentDownloadHistory({super.key});

  @override
  State<AgentDownloadHistory> createState() => _AgentDownloadHistoryState();
}

class _AgentDownloadHistoryState extends State<AgentDownloadHistory> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  agentController.friendsCount.value += 1;
                                });
                              },
                              child: Text(
                      ...
                      SizedBox(height: 24),
                      agentController.friendsCount.value > 0
                          ? Column(
                            children: [
                              TextField(
                              ...
                              ListView.builder(
                                ...
                                itemCount: agentController.friendsCount.value,
